...
const createVenue = async (req, res) => {
    ...
    try {
        let result = await (0, venueCategory_model_1.doesCategoryExist)(req.body.category_id);
        if (!result) {
            return res
                .status(400)
...
const createVenuePhoto = async (req, res) => {
    ...
    try {
        (0, google_cloud_storage_helper_1.uploadFile)(fileName, image, venuePhotoBucket).then((result) => {
            let values = [
                (0, uuid_1.v4)().replace(/-/g, ''),
                venue_id,
                result,
...
const removePhoto = async (req, res) => {
    ...
    (0, venuePhoto_model_1.removeVenuePhoto)(values)
        ...
        (0, venuePhoto_model_1.randomNewPrimary)(venue_id).then(() => {
            (0, google_cloud_storage_helper_1.removeFile)(result.photo_filename, venuePhotoBucket).then(() => {
