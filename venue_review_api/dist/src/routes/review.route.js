...
const user_routes = (app) => {
    app
        ...
        .post([...validateReviewData, user_authenticate_middleware_1.default], review_controller_1.createReview);
    app.route('/users/:id/reviews').get(user_authenticate_middleware_1.default, review_controller_1.getUserReviews);
};
