...
const validateReviewData = [
  (0, express_validator_1.check)('venue_id')
    .notEmpty()
    .withMessage('Venue is required'),
  (0, express_validator_1.check)('review_body')
    .notEmpty()
    .withMessage('Body is required'),
  (0, express_validator_1.check)('cost_rating')
    .notEmpty()
    .withMessage('Cost rating is required'),
...
const user_routes = (app) => {
  app
    ...
    .patch(
      [...validateReviewData, authenticate_middleware_1.default],
      review_controller_1.createReview,
    );
  app
    .route('/users/:id/reviews')
    .get(authenticate_middleware_1.default, review_controller_1.getUserReviews);
};
