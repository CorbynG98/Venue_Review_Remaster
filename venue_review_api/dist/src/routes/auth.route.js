...
const user_routes = (app) => {
    app.route('/auth/signin').post(validateUsernameAndPassword, auth_controller_1.login);
    app.route('/auth/signup').post(validateSignupData, auth_controller_1.create);
    app.route('/auth/signout').post(user_authenticate_middleware_1.default, auth_controller_1.signout);
};
