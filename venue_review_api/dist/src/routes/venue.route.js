...
const validateQueryParams = [
    ...
    (0, express_validator_1.query)('sortBy')
        ...
        .withMessage('Sort by must be one of star_rating, cost_rating, or distance.'),
...
const user_routes = (app) => {
    app
        ...
        .post([...validateVenueData, authenticate_middleware_1.default], venue_controller_1.createVenue);
    app
        .route('/venues/:id')
        .get(venue_controller_1.getById)
        .patch([...validateVenueData, authenticate_middleware_1.default], venue_controller_1.updateVenue);
    app.route('/categories').get(venue_controller_1.getCategories);
    app.route('/venues/:id/photos').post(authenticate_middleware_1.default, venue_controller_1.createVenuePhoto);
    app
        .route('/venues/:id/photos/:photoFilename')
        .get(venue_controller_1.getPhotoByFilename)
        .delete(authenticate_middleware_1.default, venuePhoto_model_1.removeVenuePhoto);
    app
        .route('/venues/:id/photos/:photoFilename/setPrimary')
        .post(authenticate_middleware_1.default, venue_controller_1.setNewPrimary);
};
