...
const venue_authenticate_middleware_1 = __importDefault(
  require('../util/venue_authenticate.middleware'),
);
const validateVenueData = [
  (0, express_validator_1.check)('venue_name')
    .notEmpty()
...
const user_routes = (app) => {
  app
    ...
    .post(
      [...validateVenueData, user_authenticate_middleware_1.default],
      venue_controller_1.createVenue,
    );
  app
    .route('/venues/:id')
    .get(venue_controller_1.getById)
    .patch(
      [...validateVenueData, venue_authenticate_middleware_1.default],
      venue_controller_1.updateVenue,
    );
  app.route('/categories').get(venue_controller_1.getCategories);
  app
    .route('/venues/:id/photos')
    .post(
      [...validatePhotoPrimaryField, venue_authenticate_middleware_1.default],
      venue_controller_1.createVenuePhoto,
    );
  app
  ...
  app
    ...
    .post(
      [...validatePhotoPrimaryField, venue_authenticate_middleware_1.default],
      venue_controller_1.setNewPrimary,
    );
};
