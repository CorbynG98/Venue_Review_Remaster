...
const user_routes = (app) => {
    app
        .route('/users/:id')
        .patch([...validateUserData, authenticate_middleware_1.default], user_controller_1.updateUser);
    app
        .route('/users/:id/photo')
        .get(authenticate_middleware_1.default, user_controller_1.getPhoto)
        .put(authenticate_middleware_1.default, user_controller_1.uploadPhoto)
        .delete(authenticate_middleware_1.default, user_controller_1.removePhoto);
};
